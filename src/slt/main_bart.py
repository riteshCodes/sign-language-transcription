...
def train_test_SLT_model(slt_model,
    ...
    with wandb.init(
        ...
        subset_test_dataset = Subset(validation_dataset, indices=range(128))
...
if __name__ == "__main__":
    ...
    # inference_with_checkpoint(slt_model=bart_model,
    #                           feature_extractor_model=dinov2_feature_extractor,
    #                           checkpoint_filename=checkpoint_filename)

    # train_test_subset_SLT_model(slt_model=bart_model,
    #                      feature_extractor_model=dinov2_feature_extractor)
